      ...
      <div className='container'>
        ...
        <div className="hackaton-description">
          ...
          <div className="hackaton-btn">
            ...
            <a href="https://drive.google.com/file/d/1WBfVNIARlMxOWQEndrBSHI6uqRjYyuYg/view?usp=drive_link" download="Torneo-Nocturne-Owl" className="btn btnPrimary" target="_blank" rel="noopener noreferrer"><span className="btn-text">Información</span></a>
          </div>
